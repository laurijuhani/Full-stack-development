...
const MostVotes = (props) => {
  ...
  const index = currentPoints.indexOf(Math.max(...currentPoints))

  return(
    <div>
      <h1>Anecdote with most votes</h1>
      <p>{props.anecdotes[index]}</p>
      <p>has {currentPoints[index]} votes</p>
    </div>
  )
}
...
const App = () => {
  ...
  return (
    <div>
      <AnecdoteLine anecdote={anecdotes[selected]} points={points[selected]} />
